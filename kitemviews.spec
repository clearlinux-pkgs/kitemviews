...
Version  : 5.113.0
Release  : 75
URL      : https://download.kde.org/stable/frameworks/5.113/kitemviews-5.113.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.113/kitemviews-5.113.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.113/kitemviews-5.113.0.tar.xz.sig
...
%prep
%setup -q -n kitemviews-5.113.0
cd %{_builddir}/kitemviews-5.113.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702965198
mkdir -p clr-build
pushd clr-build
