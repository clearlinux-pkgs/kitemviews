...
Source0  : https://download.kde.org/stable/frameworks/5.106/kitemviews-5.106.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.106/kitemviews-5.106.0.tar.xz.sig
...
%prep
%setup -q -n kitemviews-5.106.0
cd %{_builddir}/kitemviews-5.106.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684792309
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kitemviews-%{version}/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kitemviews/20079e8f79713dce80ab09774505773c926afa2a || :
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5ItemViews.so
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5ItemViews.so.5
/V3/usr/lib64/libKF5ItemViews.so.5.106.0
/V3/usr/lib64/qt5/plugins/designer/kitemviews5widgets.so
/usr/lib64/libKF5ItemViews.so.5
/usr/lib64/libKF5ItemViews.so.5.106.0
