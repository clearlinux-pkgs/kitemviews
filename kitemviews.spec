...
Version  : 6.0.0
Release  : 78
URL      : https://download.kde.org/stable/frameworks/6.0/kitemviews-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.0/kitemviews-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/kitemviews-6.0.0.tar.xz.sig
...
%prep
%setup -q -n kitemviews-6.0.0
cd %{_builddir}/kitemviews-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709235358
mkdir -p clr-build
pushd clr-build
