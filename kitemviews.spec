...
Version  : 6.2.0
Release  : 82
URL      : https://download.kde.org/stable/frameworks/6.2/kitemviews-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.2/kitemviews-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/kitemviews-6.2.0.tar.xz.sig
...
%setup -q -n kitemviews-6.2.0
cd %{_builddir}/kitemviews-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715620172
mkdir -p clr-build
pushd clr-build
