...
Source0  : https://download.kde.org/stable/frameworks/5.99/kitemviews-5.99.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.99/kitemviews-5.99.0.tar.xz.sig
...
%prep
%setup -q -n kitemviews-5.99.0
cd %{_builddir}/kitemviews-5.99.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665411976
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5ItemViews.so.5.99.0
