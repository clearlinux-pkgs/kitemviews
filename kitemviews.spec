...
Source0  : https://download.kde.org/stable/frameworks/5.48/kitemviews-5.48.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.48/kitemviews-5.48.0.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0 LGPL-2.1
Requires: kitemviews-lib
Requires: kitemviews-license
Requires: kitemviews-data
...
export LANG=C
export SOURCE_DATE_EPOCH=1531966304
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
cp COPYING.LIB %{buildroot}/usr/share/doc/kitemviews/COPYING.LIB
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5ItemViews.so.5.48.0

%files license
%defattr(-,root,root,-)
/usr/share/doc/kitemviews/COPYING
/usr/share/doc/kitemviews/COPYING.LIB
