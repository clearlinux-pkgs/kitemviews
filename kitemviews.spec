...
Source0  : https://download.kde.org/stable/frameworks/6.1/kitemviews-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kitemviews-6.1.0.tar.xz.sig
...
%setup -q -n kitemviews-6.1.0
cd %{_builddir}/kitemviews-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712949821
mkdir -p clr-build
pushd clr-build
