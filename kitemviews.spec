...
Source0  : https://download.kde.org/stable/frameworks/5.115/kitemviews-5.115.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.115/kitemviews-5.115.0.tar.xz.sig
...
%prep
%setup -q -n kitemviews-5.115.0
cd %{_builddir}/kitemviews-5.115.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707693250
mkdir -p clr-build
pushd clr-build
