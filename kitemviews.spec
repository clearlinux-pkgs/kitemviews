...
Version  : 5.112.0
Release  : 73
URL      : https://download.kde.org/stable/frameworks/5.112/kitemviews-5.112.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.112/kitemviews-5.112.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.112/kitemviews-5.112.0.tar.xz.sig
...
%prep
%setup -q -n kitemviews-5.112.0
cd %{_builddir}/kitemviews-5.112.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699889145
mkdir -p clr-build
pushd clr-build
